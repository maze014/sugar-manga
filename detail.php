...
<body class="bg-cover bg-center bg-fixed">
    ...
    <div class="container md:flex-row flex flex-col md:items-start mx-auto w-[90%] mt-4 pb-24 gap-4">
        ...
        <div class="bg-white/40 md:w-[60%] backdrop-blur-md rounded-xl px-4 pt-2 pb-4 shadow-lg shadow-slate-800/60">
            ...
            <button class="flex select-none mx-auto items-center gap-2 text-lg text-white font-medium bg-violet-700 shadow-md shadow-violet-700/60 transition hover:shadow-violet-700 hover:bg-violet-500 px-5 rounded-xl py-2 tracking-wider">Favorite
