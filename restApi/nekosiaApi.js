if (typeof (Storage) !== "undefined") {
    ...
    if (localStorage.getItem('waifu') === null) {
        ...
        <div class="flex justify-between item-center p-4 bg-slate-800">
            <button type="submit">
                <svg class="w-10 h-10 text-amber-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="" class="text-white font-light text-lg flex items-center">See detail
                <span>
