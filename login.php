...
<body>
    ...
    <!-- form register -->
    <div class="w-full h-[85vh] justify-center items-center flex flex-col gap-2">
        <form action="login.php" method="post" class="shadow-lg shadow-slate-800/60 w-[80%] md:w-[60%] lg:w-[50%] rounded-lg flex flex-col p-5 gap-6">
            ...
            <div class="flex flex-col justify-center gap-2">
                ...
                <div class="relative flex items-center justify-end">
                    <input class="w-full outline-0 ring-1 ring-cyan-500  p-2 rounded-md" id="password" name="password" type="password" placeholder="Masukkan password" autocomplete="off" required />
            ...
            <button name="submit" type="submit" class="bg-violet-700 rounded-full w-1/2 mx-auto font-medium text-lg text-white py-1 shadow-lg shadow-violet-800/60 md:hover:shadow-violet-800 md:transition md:duration-500 md:hover:transition md:hover:duration-500">Log In</button>
        </form>
