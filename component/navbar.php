<header class="bg-violet-600/50 backdrop-blur-md flex py-4 px-4">
    ...
    <div class="w-[35%] relative">
        <input id="keywordDesktop" class="w-full outline-0 shadow-lg shadow-slate-800/60 p-2 rounded-md" name="search" type="text" placeholder="Search for waifu" autocomplete="off" />
