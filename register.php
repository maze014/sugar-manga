...
<body>
    ...
    <div class="w-full h-[85vh] justify-center items-center flex">
        <form action="register.php" method="POST" class="shadow-lg shadow-slate-800/60 w-[80%] md:w-[60%] lg:w-[50%] rounded-lg flex flex-col p-5 gap-6">
            ...
            <button disabled id="submit" name="submit" type="submit" class="bg-violet-700 select-none rounded-full w-1/2 mx-auto font-medium text-lg text-white py-1 shadow-lg shadow-violet-800/60 md:hover:shadow-violet-800 md:transition md:duration-500 md:hover:transition md:hover:duration-500">Register</button>
        </form>
    </div>
